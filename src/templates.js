  ...
  },
  {
    ...
    template: [
      ...
      },
      {
        ...
        component: (
          <TextBlock
            text='<h1 style="text-align: center;">Place story two headline<br class="em_hide">in this position</h1>
                <p>&nbsp;</p>
      ...
      },
      {
        id: "5",
        name: "Address Footer",
        component: <AddressSection color="teal" />,
      },
    ],
  },
  {
